...
export default function UploadPage() {
  ...
  const handleFileSelection = (selectedFile: File) => {
    ...
    if (selectedFile.size > maxSize) {
      toast.error("⚠️ File size exceeds 500MB limit.");
      return;
    }
  ...
  async function handleUpload() {
    ...
    if (!file || !title.trim()) {
      toast.warning("📝 Please provide a dataset title and file.");
      return;
    }
    ...
    try {
      ...
      // ✅ Start AI Scoring
      toast.info("🤖 Gemini AI is analyzing your dataset...");
      ...
      if (aiData?.ai_confidence_score) {
        ...
        toast.warning("⚠️ AI scoring skipped — Gemini could not analyze this file.");
      }
...
export default function UploadPage() {
  ...
  async function handleUpload() {
    ...
    if (!file || !title.trim()) {
      toast.error("📝 Please provide a dataset title and file.");
      return;
    }
    ...
    try {
      ...
      if (aiData?.ai_confidence_score) {
        ...
        toast.error("⚠️ AI Scoring skipped — Gemini could not analyze this file.", {
          id: analyzeToast,
        });
      }
