...
import { useToast } from "@/components/ui/use-toast"; // make sure you have this hook in your shadcn setup
...
export default function UploadPage() {
  ...
  async function handleUpload() {
    ...
    if (!activeSession?.user?.id) {
      toast({
        title: "Not signed in",
        description: "You must be signed in to upload datasets.",
        variant: "destructive",
      });
      return;
    }
    ...
    try {
      ...
      toast({
        ...
        description: "Gemini AI is evaluating your dataset...",
      });
      ...
      if (aiData?.ai_confidence_score) {
        ...
        toast({
          title: "AI Confidence Scored ✅",
          description: `Confidence: ${aiData.ai_confidence_score}/100`,
        });
      } else {
        toast({
          title: "AI Scoring Skipped ⚠️",
          description: "Gemini could not analyze this dataset.",
          variant: "destructive",
        });
      }
          ...
          <div className="p-8 space-y-6">
            ...
            <div className="flex items-start gap-3 p-4 bg-blue-50 border border-blue-200 rounded-xl">
              ...
              <div className="text-sm text-gray-700">
                ...
                <p>
                  Ensure your dataset doesn&apos;t contain sensitive personal
                  information and complies with data-sharing guidelines.
                </p>
              </div>
            </div>
          </div>
