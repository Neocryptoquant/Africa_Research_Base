...
export default function UploadPage() {
  ...
  useEffect(() => {
    const syncSession = async () => {
      try {
        ...
        // If the user is logged in through NextAuth
        if (nextAuthSession?.supabaseAccessToken) {
          ...
          // If there's no NextAuth token, check for any existing Supabase session
    ...
    // 🔁 Keep Supabase session refreshed in real-time
  ...
  /**
   * ============================================================
   * UPLOAD LOGIC (Stable + Session Safe)
   * ============================================================
   */
  async function handleUpload() {
    // 🔍 Double check Supabase session live before upload
