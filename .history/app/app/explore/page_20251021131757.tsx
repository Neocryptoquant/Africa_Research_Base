...
export default function ExplorePage() {
  ...
  return (
    <div className="max-w-6xl mx-auto mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3 px-4">
      {datasets.length === 0 ? (
        ...
        datasets.map((ds) => (
          <div
            key={ds.id}
            className="bg-gray-900 border border-gray-800 rounded-2xl p-4 hover:border-gray-600 transition"
          >
            <div className="mb-2">
